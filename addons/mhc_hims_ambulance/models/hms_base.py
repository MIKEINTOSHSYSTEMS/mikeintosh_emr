...
class ResPartner(models.Model):
    ...
    def view_yan_ambulance_drive(self):
        action = self.env["ir.actions.actions"]._for_xml_id("mhc_hims_ambulance.action_yan_ambulance_service")
...
class HMSPatient(models.Model):
    ...
    yan_ambulance_service_count = fields.Integer(compute="_ambulance_service_count", string='#Ambulance Services', groups="mhc_hims_ambulance.group_ambulance_service_user")
